...
def serve_amex(): return _serve_asset("amex.svg",   "image/svg+xml")
@app.get("/mp-logo.svg", include_in_schema=False)
def serve_mp():   return _serve_asset("mp-logo.svg","image/svg+xml")
@app.get("/mc-logo.svg", include_in_schema=False)
def serve_mc():   return _serve_asset("mc-logo.svg","image/svg+xml")
