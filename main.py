...
@app.get("/fotolanding.png",      include_in_schema=False)
def serve_fondo(): return _serve_asset("fotolanding.png",     "image/png")
@app.get("/fotolandingcelu.png", include_in_schema=False)
def serve_fondo_celu(): return _serve_asset("fotolandingcelu.png", "image/png")
